...
integer function qmckl_compute_ao_basis_primitive_gaussian_vgl_f( &
  ...
  do inucl=1,nucl_num
    ...
    integer(c_int32_t) function qmckl_compute_ao_basis_primitive_gaussian_vgl &
      ...
      integer (c_int64_t) , intent(in)  , value :: nucleus_prim_index
      real    (c_double ) , intent(in)  , value :: elec_coord
      real    (c_double ) , intent(in)  , value :: nucl_coord
      real    (c_double ) , intent(in)  , value :: expo
...
integer function qmckl_compute_ao_basis_shell_gaussian_vgl_f( &
  ...
  do inucl=1,nucl_num
    ...
    integer(c_int32_t) function qmckl_compute_ao_basis_shell_gaussian_vgl &
      ...
      integer (c_int64_t) , intent(in)  , value :: elec_num
      integer (c_int64_t) , intent(in)  , value :: nucl_num
      integer (c_int64_t) , intent(in)  , value :: nucleus_shell_num
      integer (c_int64_t) , intent(in)  , value :: nucleus_index
      integer (c_int64_t) , intent(in)  , value :: shell_prim_index
      integer (c_int64_t) , intent(in)  , value :: shell_prim_num
      real    (c_double ) , intent(in)  , value :: elec_coord
      real    (c_double ) , intent(in)  , value :: nucl_coord
      real    (c_double ) , intent(in)  , value :: expo
      real    (c_double ) , intent(in)  , value :: coef_normalized
