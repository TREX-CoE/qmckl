...
** Access functions
   ...
   the size of the array should be also passed to check that the array
   is large enough to accept the data.
                                      ...
                                      const int64_t size_max)
{
  ...
  memcpy(nucleus_shell_num, ctx->ao_basis.nucleus_shell_num, ctx->nucleus.num * sizeof(int64_t));
  return QMCKL_SUCCESS;
}
                                  ...
                                  const int64_t size_max)
{
  ...
  memcpy(nucleus_index, ctx->ao_basis.nucleus_index, ctx->nucleus.num * sizeof(int64_t));
  return QMCKL_SUCCESS;
}
                                  ...
                                  const int64_t size_max)
{
  ...
  memcpy(shell_ang_mom, ctx->ao_basis.shell_ang_mom, ctx->ao_basis.shell_num * sizeof(int32_t));
  return QMCKL_SUCCESS;
}
                                   ...
                                   const int64_t size_max)
{
  ...
  memcpy(shell_prim_num, ctx->ao_basis.shell_prim_num, ctx->ao_basis.shell_num * sizeof(int64_t));
  return QMCKL_SUCCESS;
}
                                     ...
                                     const int64_t size_max)
{
  ...
  memcpy(shell_prim_index, ctx->ao_basis.shell_prim_index, ctx->ao_basis.shell_num * sizeof(int64_t));
  return QMCKL_SUCCESS;
}
   #+end_src
                                 ...
                                 const int64_t size_max)
{
  ...
  memcpy(shell_factor, ctx->ao_basis.shell_factor, ctx->ao_basis.shell_num * sizeof(double));
  return QMCKL_SUCCESS;
}
                             ...
                             const int64_t size_max)
{
  ...
  memcpy(exponent, ctx->ao_basis.exponent, ctx->ao_basis.prim_num * sizeof(double));
  return QMCKL_SUCCESS;
}
   #+end_src
                                ...
                                const int64_t size_max)
{
  ...
  memcpy(coefficient, ctx->ao_basis.coefficient, ctx->ao_basis.prim_num * sizeof(double));
  return QMCKL_SUCCESS;
}
                                ...
                                const int64_t size_max)
{
  ...
  memcpy(prim_factor, ctx->ao_basis.prim_factor, ctx->ao_basis.prim_num * sizeof(double));
  return QMCKL_SUCCESS;
}
                              ...
                              const int64_t size_max)
{
  ...
  return QMCKL_SUCCESS;
   ...
   #+begin_src c :comments org :tangle (eval h_func) :exports none
qmckl_exit_code qmckl_get_ao_basis_ao_factor (const qmckl_context context,
                                              double*  const ao_factor,
                                              const int64_t size_max);
   #+end_src
