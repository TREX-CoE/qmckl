...
integer function qmckl_compute_det_vgl_alpha_f(context, &
  ...
  do iwalk = 1, walk_num
   ...
   #+CALL: generate_private_c_interface(table=qmckl_compute_det_vgl_alpha_args,rettyp=get_value("CRetType"),fname="qmckl_compute_det_vgl_alpha"))
...
integer function qmckl_compute_det_vgl_beta_f(context, &
  ...
  do iwalk = 1, walk_num
   ...
   #+CALL: generate_private_c_interface(table=qmckl_compute_det_vgl_beta_args,rettyp=get_value("CRetType"),fname="qmckl_compute_det_vgl_beta"))
