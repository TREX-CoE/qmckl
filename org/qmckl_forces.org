...
{ 
  ...
  return QMCKL_SUCCESS;
     ...
     #+begin_src f90 :comments org :tangle (eval f) :noweb yes
integer(qmckl_exit_code) function qmckl_compute_forces_jastrow_delta_p_hpc2( &
     context, num_in, walk_num, elec_num, nucl_num, cord_num,   &
     een_rescaled_n, een_rescaled_e, een_rescaled_single_n, een_rescaled_single_e, &
     een_rescaled_n_gl, een_rescaled_single_n_gl, forces_delta_p) &
     result(info) bind(C)
  ...
  do nw=1, walk_num
    ...
    do l=1, cord_num-m
      do a = 1, nucl_num
        do k = 1, 3
          tmp1 = een_rescaled_n_gl(num, k, a, l, nw) - een_rescaled_single_n_gl(k,a,l,nw)
          do j = 1, elec_num
            forces_delta_p(j,k,a,l,m,nw) =  tmp1
          end do
          forces_delta_p(num,k,a,l,m,nw) = 0.d0
        end do
      end do
    end do
...
end function qmckl_compute_forces_jastrow_delta_p_hpc2
     #+end_src
...
qmckl_exit_code
qmckl_compute_forces_jastrow_delta_p_hpc2 (const qmckl_context context,
                              const int64_t num,
                              const int64_t walk_num,
                              const int64_t elec_num,
                              const int64_t nucl_num,
...
{
#ifdef HAVE_HPC
  return qmckl_compute_forces_jastrow_delta_p_hpc2
#else
...
function qmckl_compute_forces_jastrow_single_een_doc( &
     ...
     een_rescaled_single_n_gl, een_rescaled_e, een_rescaled_single_e, &
        ...
        do a = 1, nucl_num
          ...
          do kk = 1, 3
            ...
            do i = 1, elec_num
              ...
              accu5 = accu5 - een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e(i,k,nw)
              accu6 = accu6 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_e(i,num,k,nw)
            ...
            accu5 = accu5 * een_rescaled_single_n_gl(kk,a,m,nw)
            accu6 = accu6 * een_rescaled_n_gl(num,kk,a,m,nw)
            accu7 = accu7 * een_rescaled_single_n_gl(kk,a,m+l,nw)
            accu8 = accu8 * een_rescaled_n_gl(num,kk,a,m+l,nw)

            accu = accu1 + accu2 + accu3 + accu4 + accu5 + accu6 + accu7 + accu8
                                          ...
                                          double* const forces_jastrow_single_een )
{
  ...
  return qmckl_compute_forces_jastrow_single_een_doc
    ...
    (context, num, walk_num, elec_num, nucl_num, cord_num, dim_c_vector, c_vector_full, lkpm_combined_index,
     ...
     een_rescaled_e, een_rescaled_single_e, forces_jastrow_single_een );
}
  #+end_src
