...
**** Compute
     ...
     | ~tmp~                       | ~double[walk_num][0:cord_num][0:cord_num][nucl_num][4]~             | in     | Single tmp matrix                                      |
        ...
        do a = 1, nucl_num
          ...
          do kk = 1, 3
            ...
            accu = accu1 + accu2 + accu3 + accu4 + &
                   ...
                   tmp(3,a,m,k,nw) * een_rescaled_single_n_gl(kk,a,m+l,nw)+ tmp(4,a,m,k,nw) * een_rescaled_n_gl(num,kk,a,m+l,nw)
