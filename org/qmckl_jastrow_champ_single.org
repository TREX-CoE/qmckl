...
qmckl_exit_code
qmckl_compute_jastrow_champ_delta_p_g_hpc (const qmckl_context context,
                              const int64_t num,
                              const int64_t walk_num,
                              const int64_t elec_num,
                              const int64_t nucl_num,
...
qmckl_exit_code qmckl_provide_jastrow_champ_single_een_pderiv(qmckl_context context)
{
  ...
  if (ctx->single_point.date > ctx->single_point.delta_een_pderiv_date) {
    ...
    // if (mem_info.size > ctx->single_point.delta_een_pderiv_maxsize) {
    //   if (ctx->single_point.delta_een_pderiv != NULL) {
    //     rc = qmckl_free(context, ctx->single_point.delta_een_pderiv);
    //     if (rc != QMCKL_SUCCESS) {
    //       return qmckl_failwith( context, rc,
    //                              "qmckl_provide_jastrow_champ_single_een_pderiv",
    //                              "Unable to free ctx->single_point.delta_een_pderiv");
    //     }
    //     ctx->single_point.delta_een_pderiv = NULL;
    //   }
    // }
...
calculate the difference between the derivatives $\frac{\partial
J_\text{ee}}{\partial b_k}$ before and after the single electron move. If one
accociates $j$ with the index of the electron being moved then the
...
qmckl_exit_code qmckl_provide_jastrow_champ_single_ee_pderiv(qmckl_context context)
{
  ...
  if (ctx->single_point.date > ctx->single_point.delta_ee_pderiv_date) {
    ...
    // if (mem_info.size > ctx->single_point.delta_ee_pderiv_maxsize) {
    //   if (ctx->single_point.delta_ee_pderiv != NULL) {
    //     rc = qmckl_free(context, ctx->single_point.delta_ee_pderiv);
    //     if (rc != QMCKL_SUCCESS) {
    //       return qmckl_failwith( context, rc,
    //                              "qmckl_provide_jastrow_champ_single_ee_pderiv",
    //                              "Unable to free ctx->single_point.delta_ee_pderiv");
    //     }
    //     ctx->single_point.delta_ee_pderiv = NULL;
    //   }
    // }
...
accociates $i$ with the index of the electron being moved, and lets $\alpha$ run
ovel all nuclei of the same type (with the same Jastrow) then the
derivatives are given by:
...
qmckl_exit_code qmckl_provide_jastrow_champ_single_en_pderiv(qmckl_context context)
{
  ...
  if (ctx->single_point.date > ctx->single_point.delta_en_pderiv_date) {
    ...
    // if (mem_info.size > ctx->single_point.delta_en_pderiv_maxsize) {
    //   if (ctx->single_point.delta_en_pderiv != NULL) {
    //     rc = qmckl_free(context, ctx->single_point.delta_en_pderiv);
    //     if (rc != QMCKL_SUCCESS) {
    //       return qmckl_failwith( context, rc,
    //                              "qmckl_provide_jastrow_champ_single_en_pderiv",
    //                              "Unable to free ctx->single_point.delta_en_pderiv");
    //     }
    //     ctx->single_point.delta_en_pderiv = NULL;
    //   }
    // }
