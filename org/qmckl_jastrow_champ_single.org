  ...
  do nw = 1, walk_num
    do n = 1, dim_c_vector
      ...
      do a = 1, nucl_num
        ...
        do kk = 1, 3
          do i = 1, elec_num
            accu1 = een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e_gl(i,kk,k,nw) 
            accu2 = een_rescaled_n(i,a,m+l,nw) * een_rescaled_e_gl(i,kk,num,k,nw)
            accu3 = een_rescaled_n(i,a,m,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
            ...
            accu1 = -een_rescaled_n_gl(i,kk,a,m+l,nw) * een_rescaled_single_e_gl(i,kk,k,nw) 
            accu2 = -een_rescaled_n_gl(i,kk,a,m+l,nw) * een_rescaled_e_gl(i,kk,num,k,nw)
            accu3 = -een_rescaled_n_gl(i,kk,a,m,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
        ...
        do  i = 1, elec_num
          accu1 = een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e_gl(i,4,k,nw) 
          accu2 = -een_rescaled_n(i,a,m+l,nw) * een_rescaled_e_gl(i,4,num,k,nw)
          accu3 = een_rescaled_n(i,a,m,nw) * een_rescaled_single_e_gl(i,4,k,nw)
      ...
      do a = 1, nucl_num
        ...
        do kk = 1, 3
          ...
          do i = 1, elec_num
            ...
            accu1 = accu1 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
            accu2 = accu2 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_e_gl(i,kk,num,k,nw)
            accu3 = accu3 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
            accu4 = accu4 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_e(i,num,k,nw)
            accu5 = accu5 + een_rescaled_n(i,a,m,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
            accu6 = accu6 + een_rescaled_n(i,a,m,nw) * een_rescaled_e_gl(i,kk,num,k,nw)
            accu7 = accu7 + een_rescaled_n(i,a,m,nw) * een_rescaled_single_e_gl(i,kk,k,nw)
            accu8 = accu8 + een_rescaled_n(i,a,m,nw) * een_rescaled_e(i,num,k,nw)


          end do
          accu = accu1*sn_m   + accu2*n_num_m   + accu3*sn_gl_m   - accu4*n_gl_m &
               + accu5*sn_ml  + accu6*n_num_ml  + accu7*sn_gl_ml  - accu8*n_gl_ml
...
integer(qmckl_exit_code) function qmckl_compute_jastrow_champ_factor_single_een_pderiv_doc( &
  ...
  integer*8 :: i, a, j, l, k, p, m, n, nw, num
  double precision :: accu, accu1, accu2, accu3, accu4, cn, eps
  ...
  do nw =1, walk_num
     do n = 1, dim_c_vector
        ...
        do a = 1, nucl_num
           ...
           accu4 = 0.0d0
           do i = 1, elec_num
              accu1 = accu1 + een_rescaled_n(i,a,m+l,nw) * een_rescaled_single_e(i,k,nw)
              accu2 = accu2 - een_rescaled_n(i,a,m+l,nw) * een_rescaled_e(i,num,k,nw)
              accu3 = accu3 + een_rescaled_n(i,a,m,nw) * een_rescaled_single_e(i,k,nw)
              accu4 = accu4 - een_rescaled_n(i,a,m,nw) * een_rescaled_e(i,num,k,nw)
           end do

           accu = accu1 * een_rescaled_single_n(a,m,nw) + accu2 * &
                een_rescaled_n(num,a,m,nw) + accu3 * &
                een_rescaled_single_n(a,m+l,nw) + &
                accu4 * een_rescaled_n(num,a,m+l,nw)
